      ...
      <div id="logo">
       ...
       <div id="menubar">
        <ul id="menu">
          ...
          <li class="tab_selected"><a href="${pageContext.request.contextPath}/empleado/inicio">Inicio</a></li>
          <li><a href="${pageContext.request.contextPath}/empleado/asistenciaTecnica">Asistencia Tecnica</a></li>
