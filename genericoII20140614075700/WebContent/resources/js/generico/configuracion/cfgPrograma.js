...
//									{xtype:'label',text:title,cls: "ctg_label"}
						...
						columns: [
							...
							},
							{
								...
								minWidth: 300,
								sortable: true,
								dataIndex: 'cfgProgramaDescripcion',
								field: {
									xtype: 'textfield',
									allowBlank: false
								},
				...
				onDeleteClick: function(){
					...
					if(sm.getSelection()[0]){
						...
						Efx.message.confirmDelete(function(p){
							var deleteOnServer = !Ext.isEmpty(p.sm.getSelection()[0].get("cfgProgramaId"));
							p.sm.position.row = 0;
				...
				onAddClick: function(){
					var rec = new CfgPrograma({
						cfgProgramaNombre: '',
						cfgProgramaActivo: true
					}), edit = this.editing;
					edit.cancelEdit();
			...
			Ext.define('CfgPrograma', {
				extend: 'Ext.data.Model',
				idProperty: 'cfgProgramaId',
				fields: [
				    {name: 'cfgProgramaId'},
					{name: 'cfgProgramaCodigo'},
					{name: 'cfgProgramaDescripcion'}
				],
				validations:[
		            {type: 'presence',  field: 'cfgProgramaDescripcion'}
	            ]
			});
			...
			var store = Ext.create('Ext.data.Store', {
				...
				proxy: {
					type: 'ajax',
					api: {
						read: Efx.constants.CONTEXT_PATH + '/cfgPrograma/read/',
						create: Efx.constants.CONTEXT_PATH + '/cfgPrograma/create/' ,
						update: Efx.constants.CONTEXT_PATH + '/cfgPrograma/update/',
						destroy: Efx.constants.CONTEXT_PATH + '/cfgPrograma/delete/'
					},
					reader: {
						type: 'json',
						totalProperty: 'total',
